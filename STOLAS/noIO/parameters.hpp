...
const double sigma = 0.1; // pow(2.,-4.); //ksigma = 2pi sigma exp(N) / L, nsigma = sigma exp(N)
...
constexpr bool sallslice = false; // save zeta for all zoom slice
...
const double bias = 10*sqrt(dNbias); // Amplitude of the bias
